...
function AlertDialogAction({
  ...
  return (
    <AlertDialogPrimitive.Action
      className={cn(buttonVariants({ variant: "default" }), "bg-accent hover:bg-accent/90", className)}
      {...props}
    />
  )
}
...
function AlertDialogCancel({
  ...
  return (
    <AlertDialogPrimitive.Cancel
      className={cn(buttonVariants({ variant: "outline" }), "border-border hover:bg-muted", className)}
      {...props}
    />
  )
}
