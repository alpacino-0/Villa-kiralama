...
import { useSeasonalPrices } from "@/lib/hooks/use-seasonal-prices";
...
export default function VillaSeasonalPrices({ villaId }: VillaSeasonalPricesProps) {
  // Oluşturduğumuz hook'u kullanarak verileri al
  const { seasonalPrices, isLoading, error } = useSeasonalPrices(villaId);
