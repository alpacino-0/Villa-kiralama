...
export function calculateTotalPrice(
  ...
  for (let i = 0; i < totalDays; i++) {
    ...
    dailyPrices.push({
      date: formattedDate,
      price: event.price,
      isSpecialOffer: event.eventType?.includes(EventType.SPECIAL_OFFER) || false,
...
export function useSeasonalPriceCalculator(
  ...
  }, [villaId, startDate, endDate, calendarEvents, cleaningFee, shortStayDayLimit, calculatePayment, advancePaymentRate]);
